...
// etre sur de ne pas avoir de boucle infini
loopPlay ? '' : game();
loopPlay = true;
...
function game(){
    ...
    const youWin = () => {
        ...
        endScreen.innerHTML = `<div class="youWin">bravo ! tu as atomisé cette cochonerie<br/><span>précision : ${accuracy}%</span></div>`
        endScreen.style.visibility = 'visible';
        endScreen.style.opacity = '1';
        loopPlay = false ;
    };
...
// si jamais la class element est virus enleve.
